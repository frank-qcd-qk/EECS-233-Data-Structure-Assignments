...
public class frankDS {
    ...
    private LinkedList<Object> prioritizeLinkedList = new LinkedList<Object>();
    ...
    public frankDS(int maximumSize, int maxResource) {
        ...
        for (int i = 0; i < 10; i++) {
            prioritizeLinkedList.add(new Group1_Queue<>(maximumSize));
        }
    }
    ...
    public synchronized Object[] updateNextInLine(int RID) {
        ...
        while (i < 10 && !found) {
            ...
            Group1_Queue<?> local = (Group1_Queue<?>) prioritizeLinkedList.get(i);
            ...
            this.prioritizeLinkedList.set(i, parseThrough);
            i++;
        }
    ...
    public synchronized void addQueue(int priority, Object interestingQueue) {
        ...
        Group1_Queue<?> extraction = (Group1_Queue<?>) this.prioritizeLinkedList.get(priority); // A wired pointer manip
